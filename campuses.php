...
<body>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/slider/slider-1.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Our Campuses</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Our Campuses</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                    ...
                    <div class="col-lg-6">
                        <div class="content-info wow fadeInUp" data-wow-delay=".25s">
                            <div class="site-heading mb-3">
                                <span class="site-title-tagline"> Campuses
                                </span>
                                <h2 class="site-title">
                                    Details About <span>Henson Demonstration Schools</span> Campuses.
                                </h2>
                            </div>
