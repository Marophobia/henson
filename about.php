                        ...
                        <div class="about-left wow fadeInLeft" data-wow-delay=".25s">
                            <div class="about-img">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <img class="img-2" src="assets/img/about/02.jpg" alt="School Assembly">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="content-img wow fadeInLeft" data-wow-delay=".25s">
                            <img src="assets/img/about/anthem.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="content-info wow fadeInUp" data-wow-delay=".25s">
                            <div class="site-heading mb-3">
                                <span class="site-title-tagline">Our School</span>
                                <h2 class="site-title">
                                    Discover our <span>School Anthem</span> and Pledge
                                </h2>
                            </div>
                            <p class="content-text">
                                ...
                                Feathers of green exploit <br>
                                Demonstration group of school <br>
